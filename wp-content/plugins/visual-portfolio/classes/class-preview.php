...
class Visual_Portfolio_Preview {
    ...
    public function print_template() {
        ...
        wp_enqueue_script( 'visual-portfolio-preview', visual_portfolio()->plugin_url . 'assets/js/preview.js', array( 'jquery', 'iframe-resizer-content' ), '2.5.0', true );
        ...
        // Custom styles.
        visual_portfolio()->include_template_style( 'visual-portfolio-preview', 'preview/style', array(), '2.5.0' );
