...
class Visual_Portfolio_Elementor_Widget extends \Elementor\Widget_Base {
    ...
    public function __construct( $data = array(), $args = null ) {
        ...
        if ( $this->is_preview_mode() ) {
            ...
            wp_register_script( 'visual-portfolio-elementor', visual_portfolio()->plugin_url . 'assets/admin/js/elementor.min.js', array( 'elementor-frontend', 'iframe-resizer', 'jquery' ), '2.5.0', true );

            wp_register_style( 'visual-portfolio-elementor', visual_portfolio()->plugin_url . 'assets/admin/css/elementor.min.css', array(), '2.5.0' );
